...
Tato nejednotnost má za následek, že studenti musí neustále přepínat mezi různými zdroji a porovnávat jejich informace se skripty, což je spíše matoucí než prospěšné pro jejich učení.
...
Přestože je aplikace primárně cílena na studenty univerzitních oborů informatiky jakožto podpůrný nástroj k přednáškám a cvičením, její moderní uživatelské rozhraní a přístupnost jsou navrženy tak, aby bariéra vstupu byla co nejnižší.
...
Po tomto úvodu následuje \customref{Kapitola}{chap:content}, která shrnuje teoretické základy implementovaných datových struktur a algoritmů.
